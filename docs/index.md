...
|----------|----------------|-------------|----------------|----------------|
| 4.5.8-4.7.0 GA | v0.0.27rc2 | v0.0.22.post1 | v0.0.13 | v0.0.13 |
...
- Plugin version `0.0.27rc2` in source
...
Current backend-runtime pairing: netbox-proxbox 0.0.27rc2 <-> proxbox-api 0.0.22.post1 <-> proxmox-sdk 0.0.13 <-> netbox-sdk 0.0.13. This netbox-sdk version is proxbox-api's REST dependency only and does not provide the semantic MCP bridge.

The `0.0.27rc2` release adds NetBox-native search and filtering to the Proxbox virtual machines list while retaining the production console handoff, Proxmox metrics, soft-deleted VM purge surface, and the official NetBox 4.7.0 GA compatibility contract. The historical rows remain documented below.
