...
- Proxbox `0.0.21rc1` is the current release candidate for NetBox `4.5.8`, `4.5.9`, and `4.6.x` (validated against `v4.5.8`, `v4.5.9`, `v4.6.0`, and official `v4.6.1`; declared compatibility range `4.5.8` through `4.6.99`). It pairs with the separate `proxbox-api` backend release `0.0.18rc1`. Plugin version `0.0.21` on the `0.0.21rc1` release line. The previous stable `0.0.20.post3` release pairs with backend `0.0.17.post1`.
