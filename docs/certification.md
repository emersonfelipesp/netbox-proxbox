...
| Compatibility | NetBox `4.5.8` through `4.7.0`, including official `v4.7.0` GA; verified against `v4.5.8`, `v4.5.9`, `v4.5.10`, `v4.6.0`, `v4.6.1`, `v4.6.2`, `v4.6.3`, `v4.6.4`, `v4.6.5`, `v4.6.6`, and `v4.7.0` |
| Source stack | `netbox-proxbox 0.0.27rc4`, `proxbox-api 0.0.23`, `proxmox-sdk 0.0.15`, and `netbox-sdk 0.0.13`; released historical pairings remain in `COMPATIBILITY.md` |
| Tests | GitHub Actions run lint, typecheck, compile, pytest, E2E Docker, page coverage, screenshots, docs, and release validation |
