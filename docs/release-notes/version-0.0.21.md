...
netbox-proxbox `0.0.21` pairs with the `proxbox-api 0.0.18.post3`
...
|---------|----------------|-------------|------------|-------------|
| >=4.5.8 | v0.0.21 | v0.0.18.post3 | v0.0.10 | v0.0.12 |
