...
- Verifies the repository association after idempotent deployment-attestation linking so Gitea's already-linked response cannot mark an otherwise successful production deployment as failed.
