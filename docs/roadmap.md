...
- Improve deletion handling when Proxmox nodes disappear from the source environment
- Expand targeted sync beyond the current per-VM and staged sync actions
- Create virtual machines and containers directly from NetBox instead of discovery-only sync
- Add console access shortcuts for virtual machines
- Continue improving documentation and release-note coverage
