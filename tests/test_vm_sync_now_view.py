...
def test_vm_sync_now_view_enqueues_targeted_vm_bundle(monkeypatch):
    ...
    assert captured["sync_types"] == [
        vm_sync_now.SyncTypeChoices.VIRTUAL_MACHINES,
        vm_sync_now.SyncTypeChoices.VIRTUAL_MACHINES_BACKUPS,
        vm_sync_now.SyncTypeChoices.VIRTUAL_MACHINES_SNAPSHOTS,
    ]
