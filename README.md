...
- **Release-candidate validation complete.** RC18 passed Page Coverage,
  TestPyPI validation on Python 3.12 and 3.13, and all 66 Docker E2E cells.
...
- **Verified virtual-machine identity in release validation.** Page Coverage
  ...
  incomplete, malformed, ambiguous, or ignored-filter responses, and verifies
  the linked NetBox virtual machine before evaluating synchronized relations.
