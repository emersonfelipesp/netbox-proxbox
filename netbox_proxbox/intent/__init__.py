...
netbox-branching branch whose plugin-owned intent sets
``apply_to_proxmox=True``, validates
...
per-branch ``apply_to_proxmox`` intent gate, RBAC, and (for DELETE) a separate
