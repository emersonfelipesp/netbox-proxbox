...
def push_ct_rules(
    ...
    *,
    ...
    for rule in rules:
        validate_vm_firewall_scope(
            rule, endpoint=endpoint, vmid=vmid, node=node, vm_type="lxc"
        )
...
def push_ct_ipsets(
    ...
    *,
    ...
    for ipset in ipsets:
        validate_vm_firewall_scope(
            ipset, endpoint=endpoint, vmid=vmid, node=node, vm_type="lxc"
        )
...
def push_ct_ipset_entries(
    ...
    *,
    ...
    for entry in entries:
        validate_vm_firewall_scope(
            entry, endpoint=endpoint, vmid=vmid, node=node, vm_type="lxc"
        )
...
def push_ct_aliases(
    ...
    *,
    ...
    for alias in aliases:
        validate_vm_firewall_scope(
            alias, endpoint=endpoint, vmid=vmid, node=node, vm_type="lxc"
        )
...
def push_ct_options(
    ...
    *,
    ...
    validate_vm_firewall_scope(
        options, endpoint=endpoint, vmid=vmid, node=node, vm_type="lxc"
    )
