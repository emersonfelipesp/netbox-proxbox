...
The current plugin config lives in [`netbox_proxbox/__init__.py`](./netbox_proxbox/__init__.py). It declares plugin version `0.0.13.post4` and NetBox compatibility `4.5.8` through `4.6.99` (certified against `4.5.8`, `4.5.9`, and `4.6.0-beta2`).
