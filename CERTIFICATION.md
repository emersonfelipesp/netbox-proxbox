...
- Certification target artifact: `0.0.26.post10` (local source)
- Verified stable NetBox targets: `v4.5.8`, `v4.5.9`, `v4.5.10`, `v4.6.0`, `v4.6.1`, `v4.6.2`, `v4.6.3`, `v4.6.4`, `v4.6.5`, and `v4.6.6`
- Verified GA target: `v4.7.0` at `5f06007e4c9bacc93ce17c1e645fc1143d60df3d` (plugin/Django compatibility only: end-to-end PVE synchronization on NetBox 4.7.0 through the paired published backend, proxbox-api 0.0.19.post5 through 0.0.21.post7, is known-broken and excluded from the release-validation matrix)
