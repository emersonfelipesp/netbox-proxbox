...
Current source pairing: netbox-proxbox 0.0.27rc11 <-> proxbox-api 0.0.23.post1 <-> proxmox-sdk 0.0.15 <-> netbox-sdk 0.0.13. This is the current sibling-source development stack. The netbox-sdk version is proxbox-api's REST dependency only and does not provide the semantic MCP bridge.
...
|---|---|---|---|---|---|
| v0.0.27rc11 (current source) | 4.5.8-4.7.0 GA | >=3.12 | v0.0.23.post1 | v0.0.13 | v0.0.15 |
